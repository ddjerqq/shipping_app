        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    occured_on = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    address_info = table.Column<string>(type: "TEXT", nullable: true),
                    culture_info = table.Column<string>(type: "TEXT", nullable: false),
                    time_zone = table.Column<string>(type: "TEXT", nullable: false),
                    room_code = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    invoice_file_key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    picture_file_key = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
